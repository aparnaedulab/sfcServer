...
module.exports = function(sequelize, DataTypes) {
  var User_Course_Enrollment_Detail_PDC = sequelize.define("User_Course_Enrollment_Detail_PDC", {
  ...
  ,{
    ...
    sequelize,
    tableName: 'User_Course_Enrollment_Detail_PDC',
    timestamps: true,
  ...
  // {
  //   classMethods: {
    User_Course_Enrollment_Detail_PDC.assigndata = function(user_id){
          var query='';
          ...
          User_Course_Enrollment_Detail_PDC.getAlldata = function() {
        var query = 'Select * from User_Course_Enrollment_Detail';
        // 
        return sequelize.query(query, { type: sequelize.QueryTypes.SELECT});
        };
        User_Course_Enrollment_Detail_PDC.getListLastData = function() {
          var query='';
          ...
          query +=" SELECT id , enrollment_no From User_Course_Enrollment_Detail_PDC ";
          query +=" WHERE id=(SELECT MAX(id) FROM User_Course_Enrollment_Detail_PDC)";
  ...
  // });
      ...
      User_Course_Enrollment_Detail_PDC.getApplicationDetailsById = function(app_id){
        ...
        query += " FROM Application AS app JOIN User_Course_Enrollment_Detail_PDC AS ued ON ued.application_id = app.id ";
  ...
  return User_Course_Enrollment_Detail_PDC;
};
